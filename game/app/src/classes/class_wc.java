...
public final class class_wc extends class_aae {
	...
	private class_wc() {
		this.k = new String[][] {
				...
				{ "Nhiệm vụ" },
				{ "Đồ sát" },
				{ "Khác", "Tin nhắn", "Nhóm", "Bạn bè", "Top cao thủ", "Top đại gia", "Bảng Top", "Kênh thế giới", "Diễn đàn", "Rời bang" }, // 6
				{ "" }, // 7 (Bang hoi)
				{ "Cửa hàng" }, // 8
				{ "Thoát" }, // 9
	...
	private void g() {
		System.out.println("g() called with this.e=" + this.e + " this.b=" + this.b);
		if (this.e == -1) {
