...
extends class_ap {
    ...
    public void a() {
        ...
        switch (((class_vh)this).cV) {
            ...
            case 0: {
                this.O = 0;
                ++this.Y;
                if (this.Y <= this.Z || this.f != -1) break;
                short s = (short)(((class_vh)this).cO - this.ad);
                short s2 = (short)(((class_vh)this).cO + this.ad);
                short s3 = (short)(((class_vh)this).cP - this.ad);
                short s4 = (short)(((class_vh)this).cP + this.ad);
                short s5 = (short)class_ap.V.nextInt(4);
                if (this.aa != -100 && this.aa == s5) {
                    if (s5 == 2) {
                        s5 = 3;
                    } else if (s5 == 3) {
                        s5 = 2;
                ...
                if (s5 == 2) {
                    this.ab = (byte)(-this.I);
                    this.ac = 0;
                    if (Math.abs(((class_vh)this).cK - s) < 32) {
                        s5 = 3;
                        this.ab = (byte)this.I;
                    }
                } else if (s5 == 3) {
                    this.ab = (byte)this.I;
                    this.ac = 0;
                    if (Math.abs(((class_vh)this).cK - s2) < 32) {
                        s5 = 2;
                        this.ab = (byte)(-this.I);
                    }
                } else if (s5 == 1) {
                    this.ab = 0;
                    this.ac = (byte)(-this.I);
                    if (Math.abs(((class_vh)this).cL - s3) < 32) {
                        s5 = 0;
                        this.ac = (byte)this.I;
                    }
                } else if (s5 == 0) {
                    this.ab = 0;
                    this.ac = (byte)this.I;
                    if (Math.abs(((class_vh)this).cL - s4) < 32) {
                        s5 = 1;
                        this.ac = (byte)(-this.I);
                    }
                }
    ...
    public void b() {
        ...
        if (this.f == -1) {
            short s = (short)(((class_vh)this).cO - this.ad + this.I);
            short s2 = (short)(((class_vh)this).cO + this.ad - this.I);
            short s3 = (short)(((class_vh)this).cP - this.ad + this.I);
            short s4 = (short)(((class_vh)this).cP + this.ad - this.I);
            int n = ((class_vh)this).cK - this.I;
            int n2 = ((class_vh)this).cK + this.I;
            int n3 = ((class_vh)this).cL - this.I;
            int n4 = ((class_vh)this).cL + this.I;
            int n5 = class_ap.V.nextInt(50);
            if (((class_vh)this).cK >= s2 && this.D == 3 || ((class_vh)this).cK <= s && this.D == 2 || ((class_vh)this).cL <= s3 && this.D == 1 || ((class_vh)this).cL >= s4 && this.D == 0 || class_ls.a((int)n, (int)((class_vh)this).cL, (int)2) && this.D == 2 || class_ls.a((int)n2, (int)((class_vh)this).cL, (int)2) && this.D == 3 || class_ls.a((int)((class_vh)this).cK, (int)n3, (int)2) && this.D == 1 || class_ls.a((int)((class_vh)this).cK, (int)n4, (int)2) && this.D == 0 || n5 == 5) {
                this.k = 0;
                this.j = 0;
                this.i = 0;
                ((class_vh)this).cV = 0;
            ...
            ((class_vh)this).cK = (short)(((class_vh)this).cK + this.ab);
            ((class_vh)this).cL = (short)(((class_vh)this).cL + this.ac);
            return;
        }
        boolean bl = false;
        boolean bl2 = false;
